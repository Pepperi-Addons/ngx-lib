import { ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, ɵɵdirectiveInject, Renderer2, ElementRef, ɵɵdefineComponent, ɵɵprojectionDef, ɵɵprojection, Component, ChangeDetectionStrategy, Optional, Inject, Input, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
import { DOCUMENT } from '@angular/common';

class PepperiIconRegistry {
    constructor() {
...
PepperiIconRegistry.ɵprov = ɵɵdefineInjectable({ token: PepperiIconRegistry, factory: PepperiIconRegistry.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { ɵsetClassMetadata(PepperiIconRegistry, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
PepperiIconComponent.ɵfac = function PepperiIconComponent_Factory(t) { return new (t || PepperiIconComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(PepperiIconRegistry), ɵɵdirectiveInject(DOCUMENT, 8)); };
PepperiIconComponent.ɵcmp = ɵɵdefineComponent({ type: PepperiIconComponent, selectors: [["pep-icon"]], inputs: { name: "name", fill: "fill" }, ngContentSelectors: _c0, decls: 1, vars: 0, template: function PepperiIconComponent_Template(rf, ctx) { if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵprojection(0);
    } }, styles: ["[_nghost-%COMP%] {\n            display: inline-grid;\n        }\n\n        [_nghost-%COMP%]  svg { width: 1.5rem; height: 1.5rem }"], changeDetection: 0 });
/*@__PURE__*/ (function () { ɵsetClassMetadata(PepperiIconComponent, [{
        type: Component,
        args: [{
                selector: 'pep-icon',
                template: `
    ...
    }], function () { return [{ type: Renderer2 }, { type: ElementRef }, { type: PepperiIconRegistry }, { type: undefined, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [DOCUMENT]
...
const pepperiIconArrowRightAlt = {
...
const pepperiIconArrowTwoWaysHorL = {
...
const pepperiIconArrowTwoWaysHorR = {
...
const pepperiIconArrowTwoWaysVerB = {
...
const pepperiIconArrowTwoWaysVerT = {
...
const pepperiIconIndicatorDotPlaceholder = {
...
const pepperiIconNumberDecimal = {
    name: 'number_decimal',
...
const pepperiIconNumberPercent = {
    name: 'number_percent',
...
const pepperiIconShoppingPaper = {
    name: 'shopping_paper',
...
const pepperiIconSystemDotEllipsis = {
...
const pepperiIconSystemEducation = {
...
const pepperiIconSystemFileDownload = {
...
const pepperiIconSystemFileUploadCloud = {
...
const pepperiIconSystemFileUpload = {
...
const pepperiIconSystemFullScreen = {
...
const pepperiIconSystemInventory = {
...
const pepperiIconSystemMenuDots = {
...
const pepperiIconSystemOffLine = {
...
const pepperiIconSystemProcessing = {
...
const pepperiIconSystemQuestion = {
...
const pepperiIconSystemRotateDevice = {
...
const pepperiIconSystemSettings = {
...
const pepperiIconSystemSignature = {
...
const pepperiIconSystemSpinner = {
    name: 'system_spinner',
...
const pepperiIconSystemSupport = {
    name: 'system_support',
...
const pepperiIconSystemTexterea = {
...
class PepperiIconModule {
}
PepperiIconModule.ɵmod = ɵɵdefineNgModule({ type: PepperiIconModule });
PepperiIconModule.ɵinj = ɵɵdefineInjector({ factory: function PepperiIconModule_Factory(t) { return new (t || PepperiIconModule)(); }, imports: [[]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(PepperiIconModule, { declarations: [PepperiIconComponent], exports: [PepperiIconComponent] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(PepperiIconModule, [{
        type: NgModule,
        args: [{
...
export { PepperiIconComponent, PepperiIconModule, PepperiIconRegistry, pepperiIconArrowBack, pepperiIconArrowDown, pepperiIconArrowDownAlt, pepperiIconArrowEither, pepperiIconArrowLeft, pepperiIconArrowLeftAlt, pepperiIconArrowRight, pepperiIconArrowRightAlt, pepperiIconArrowTwoWaysHorL, pepperiIconArrowTwoWaysHorR, pepperiIconArrowTwoWaysVerB, pepperiIconArrowTwoWaysVerT, pepperiIconArrowUp, pepperiIconArrowUpAlt, pepperiIconBarndPepperi, pepperiIconIndicatorDotPlaceholder, pepperiIconMiscExcel, pepperiIconNoImage, pepperiIconNumberCoins, pepperiIconNumberDecimal, pepperiIconNumberDollar, pepperiIconNumberEuro, pepperiIconNumberMinus, pepperiIconNumberNumber, pepperiIconNumberPercent, pepperiIconNumberPlus, pepperiIconShoppingCart, pepperiIconShoppingPaper, pepperiIconSystemAttach, pepperiIconSystemAvatar, pepperiIconSystemBin, pepperiIconSystemBolt, pepperiIconSystemChat, pepperiIconSystemCircle, pepperiIconSystemClose, pepperiIconSystemDoc, pepperiIconSystemDoor, pepperiIconSystemDotEllipsis, pepperiIconSystemEdit, pepperiIconSystemEducation, pepperiIconSystemEmail, pepperiIconSystemFileDownload, pepperiIconSystemFileUpload, pepperiIconSystemFileUploadCloud, pepperiIconSystemFilter, pepperiIconSystemFullScreen, pepperiIconSystemHeart, pepperiIconSystemHome, pepperiIconSystemInfo, pepperiIconSystemInventory, pepperiIconSystemLink, pepperiIconSystemMap, pepperiIconSystemMenu, pepperiIconSystemMenuDots, pepperiIconSystemMove, pepperiIconSystemMust, pepperiIconSystemOffLine, pepperiIconSystemOk, pepperiIconSystemPause, pepperiIconSystemPhone, pepperiIconSystemPlay, pepperiIconSystemPrint, pepperiIconSystemProcessing, pepperiIconSystemQuestion, pepperiIconSystemRotateDevice, pepperiIconSystemSearch, pepperiIconSystemSelect, pepperiIconSystemSettings, pepperiIconSystemSignature, pepperiIconSystemSpinner, pepperiIconSystemSupport, pepperiIconSystemTexterea, pepperiIconSystemTool, pepperiIconSystemView, pepperiIconTimeCal, pepperiIconTimeDatetime, pepperiIconTimeDuration, pepperiIconTimeTime, pepperiIconViewCardLg, pepperiIconViewCardMd, pepperiIconViewCardSm, pepperiIconViewLine, pepperiIconViewMatrix, pepperiIconViewTable };
