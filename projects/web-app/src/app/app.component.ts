...
import { CustomizationService, HttpService, ObjectSingleData, DataConvertorService,
    ObjectsData, PepperiRowData, PepperiFieldData, AddonService, FIELD_TYPE, UtilitiesService } from '@pepperi-addons/ngx-lib';
...
import { PepperiListComponent, ChangeSortingEvent, VIEW_TYPE } from '@pepperi-addons/ngx-lib/list';
import { ChangeEvent } from '@pepperi-addons/ngx-lib/list/virtual-scroll.component';
...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    groupButtons: Array<PepperiGroupButton>;
    GROUP_BUTTONS_VIEW_TYPE = GROUP_BUTTONS_VIEW_TYPE;

    colorType = PepColorType.AnyColor;

    addons: [];
    @ViewChild(PepperiListComponent) customList: PepperiListComponent;
    ...
    ngOnInit() {
        ...
        this.addons = this.appService.getAddons()
    ...
    convertAddonToPepperiRowData(addon: any, customKeys = null) {
    ...
    initDataRowField(addon: any, key: any): PepperiFieldData {

        const dataRowField: PepperiFieldData = {
            ApiName: key,
