...
@Component({
    selector: 'pep-internal-field-generator',
    templateUrl: './internal-field-generator.component.html',
    styleUrls: ['./internal-field-generator.component.scss'],
    encapsulation: ViewEncapsulation.Emulated,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PepInternalFieldGeneratorComponent implements OnChanges, OnDestroy {
    private _field: any;
    @Input()
    set field(value: any) {
        this._field = value;
